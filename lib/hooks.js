...
export function useSearchObjects(arrayOfObjects, sortBy) {


    const [searchTerm, setSearchTerm] = useState('')
    const filteredObjects = arrayOfObjects
        .filter(u => JSON.stringify(u)
            .toLowerCase()
            .includes(searchTerm.toLowerCase())
        )

    return filteredObjects.sort(dynamicSort(sortBy))
